...
function Exhibits( {exhibits} ) {
    ...
    function getExhibit(exhibit) {
        return (
            <Grid item key={exhibit.slug} xs={12} sm={12} md={6} lg={6} xl={6}>
                <Card key={exhibit.title} className={scss.root}>
                    ...
                    <div className={scss.exhibitionText}>
                        <CardContent style={{padding: 0, margin: 0, display: "flex"}}>
                            <CardContent>
                                <Link href={`/exhibits/${exhibit.slug}`}><a>
                                    <h2
                    ...
                    <div className={scss.wrapper}>
                        <Container>
                            <Grid container spacing={8}>
                                {exhibits.map(exhibit => getExhibit(exhibit))}
                            </Grid>
                        </Container>
                    </div>
                </div>
